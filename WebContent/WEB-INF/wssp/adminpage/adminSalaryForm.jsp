					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="fresh-table">
								<div class="toolbar">
									<form action="${pageContext.request.contextPath }/admin/adminSalaryFormDepartment.do" method="post">
								...
								<table id="fresh-table" class="table">
									...
									<tbody>
										<c:forEach items="${lSalary }" var="ls">
											<tr>
												<td>${ls.sid }</td>
												<td>${ls.student.sname }</td>
												<td>${ls.student.sdepartment }</td>
												<td>${ls.area}</td>
												<td>${ls.reward}</td>
												<td>${ls.student.bank}</td>
												<td>${ls.student.phone}</td>
												<td>操作</td>
